...
const App = () => {
  ...
  console.log("Version check",JSON.stringify(VersionCheck.getPlayStoreUrl({ packageName: 'com.crompton.greaves' })))
    useEffect(() => {
      ...
      useEffect(() => {
        const checkAppVersion = async () => {
          try {
    const latestVersion = Platform.OS === 'ios'? await fetch(`https://itunes.apple.com/in/lookup?bundleId=com.crompton.greaves`)
                    .then(r => r.json())
