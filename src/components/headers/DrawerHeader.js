...
const DrawerHeader = () => {
    ...
    return (
        <View style={{height:60,width:'100%',flexDirection:"row",alignItems:"center",marginBottom:20,backgroundColor:"white"}}>
            ...
            <View style={{alignItems:'center',justifyContent:'center',flexDirection:'row',marginLeft:80}}>
          <PoppinsTextMedium style={{color:'#075CA9',fontSize:24,fontWeight:'bold'}} content= "CG "></PoppinsTextMedium>
          <PoppinsTextMedium style={{color:'#80C343',fontSize:24,fontWeight:'bold'}} content= "Vishwas"></PoppinsTextMedium>
        </View>
